...
exports.defineJobFactory = exports.defineInspectionFactory = exports.defineReminderFactory = exports.defineAppointmentFactory = exports.defineUserFactory = exports.initialize = exports.resetScalarFieldValueGenerator = exports.registerScalarFieldValueGenerator = exports.resetSequence = void 0;
...
function autoGenerateUserScalarsOrEnums({ seq }) {
    return {
        ...
        color: (0, internal_1.getScalarFieldValueGenerator)().String({ modelName: "User", fieldName: "color", isId: false, isUnique: false, seq }),
...
function autoGenerateAppointmentScalarsOrEnums({ seq }) {
    return {
        ...
        vehicleDescription: (0, internal_1.getScalarFieldValueGenerator)().String({ modelName: "Appointment", fieldName: "vehicleDescription", isId: false, isUnique: false, seq }),
